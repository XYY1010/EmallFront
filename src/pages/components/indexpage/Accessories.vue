<template>
  ...
  <div class="around-container">
      <div class="goods-top clearfix">
        ...
        <ul class="top-sub">
          <li v-for="sub in subs" :class="{'active' : topSubStatus === sub.key}" @mouseenter="topSubEnter(sub.key)" style="list-style: none;">{{sub.name}}</li>
        </ul>
      </div>
    ...
    return {
      topTitle: '配件',
			...
			hot: [
				...
				reviewDesc: '', reviewAuthor: '', reviewStatus: false},
				{moreUrl: '//list.mi.com/pjrm', sourceUrl: '//item.mi.com/1154100024.html', imgUrl: '//i2.mifile.cn/a1/T1Zp__B5Ev1RXrhCrK.jpg?width=80&height=80', title: 'ZMI无限拓展数据线 120cm', price: '29', moreItem: '热门'}
			],
			protect: [
				...
				{moreUrl: '//list.mi.com/7', sourceUrl: '//item.mi.com/1155100020.html', imgUrl: '//i1.mifile.cn/a1/T1QKJ_BvLv1RXrhCrK!220x220.jpg', title: '平板2保护套', price: '69', moreItem: '保护套'}
			],
			fiol: [
				...
				{moreUrl: '//list.mi.com/9', sourceUrl: '//item.mi.com/1160800005.html', imgUrl: '//i1.mifile.cn/a1/T1keE_BsJv1RXrhCrK!220x220.jpg ', title: '小米手机5 标准高透贴膜', price: '19', moreItem: '贴膜'}
			],
			other: [
				...
				{moreUrl: '//list.mi.com/others', sourceUrl: '//item.mi.com/1154900025.html', imgUrl: '//i1.mifile.cn/a1/T1_7KgB4Jv1RXrhCrK!220x220.jpg', title: '青米USB快速充电数据线', price: '24.9', moreItem: '其他配件'}
			]
    }
  },
  mounted() {
...
.goods-top .top-sub li.active {
  color: #A013EB;
  border-bottom: 2px solid #A013EB;
}
</style>
